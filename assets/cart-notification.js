  ...
  renderContentsAfterAddToCartPopup(parsedState) {
    if (parsedState && parsedState.sections && parsedState.items && parsedState.items.length) {
      if (parsedState.sections["cart-notification-product"]) {
        this.notification.querySelector("#cart-notification-product").outerHTML = this.getSectionInnerHTML(parsedState.sections["cart-notification-product"], "[id='shopify-section-cart-notification-product'");
      }
